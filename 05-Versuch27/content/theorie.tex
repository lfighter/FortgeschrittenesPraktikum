...
\begin{gather*}
	E_{pot}=-\vec{\mu_{J}} \cdot \vec{B} = -\mu_{J_{||}} \cdot B= \mu_B g_J B \cdot m.
\end{gather*}
Es ergibt sich im Magnetfeld die in Abbildung \ref{fig:generelleAufspaltung} dargestellte Aufspaltung der Energieniveaus.
\begin{figure}
	\centering
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth-250pt,height=\textheight-250pt,keepaspectratio]{content/Images/linien.png}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth-250pt,height=\textheight-250pt,keepaspectratio]{content/Images/normaleAufspaltung.png}
    \caption{??? \cite{V27}.}
